...
PyObject *GTFoldPythonRuntimeException = NULL;
...
PyMODINIT_FUNC PyInit_GTFoldPython(void) {
     ...
     GTFoldPythonRuntimeException = PyErr_NewException("GTFoldPython.error", NULL, NULL);
     Py_XINCREF(GTFoldPythonRuntimeException);
     if(PyModule_AddObject(moduleObj, "error", GTFoldPythonRuntimeException) < 0) {
          Py_XDECREF(GTFoldPythonRuntimeException);
          Py_CLEAR(GTFoldPythonRuntimeException);
          Py_DECREF(moduleObj);
          return NULL;
     }
     return moduleObj;
